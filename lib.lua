...
-- Library functions 
    ...
    -- Library element functions
        function library:window(properties)
            local cfg = {
                name = properties.name or properties.Name or "bobr",
        ...
        local watermark = library:watermark({name = "bobr - 100 fps - 100 ping"})
        local fps = 0
        ...
        run.RenderStepped:Connect(function()
            ...
            if tick() - watermark_delay > 1 then 
                ...
                watermark.update_text(string.format("bobr - fps: %s - ping: %s", fps, ping))
                fps = 0
            end
        end)
	...
	fpsLabel.Text = "FPS: " .. tostring(math.floor(realFPS))
        ...
        function library:column(properties)
            ...
            local accent_index = (self.count - 1) % 2 + 1

            local cfg = {color = library.gradient.Color.Keypoints[accent_index].Value, count = accent_index} 
